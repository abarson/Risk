...
/**
 * Write a description of class Siberia here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Siberia extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("SiberiaRed.png");
        else if(currentColor.equals("black"))
            setImage("SiberiaBlack.png");
        else if(currentColor.equals("blue"))
            setImage("SiberiaBlue.png");
        else if(currentColor.equals("green"))
            setImage("SiberiaGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("SiberiaLBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("SiberiaYellow.png");
    }
    //-----------------------------------------------------------------------------//
