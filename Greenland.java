 ...
 */
public class Greenland extends Territories
{
    /**
     * Act - do whatever the Greenland wants to do. This method is called whenever
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("GreenlandRed.png");
        else if(currentColor.equals("black"))
            setImage("GreenlandBlack.png");
        else if(currentColor.equals("blue"))
            setImage("GreenlandBlue.png");
        else if(currentColor.equals("green"))
            setImage("GreenlandGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("GreenlandLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("GreenlandYellow.png");
    }
    public void act() 
    {
        imageSelect();
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("Iceland"))
            ...
            return true;
        else if(tempName.equals("Quebec"))
            return true;
        return false;
    }
    public void fortify(){
