...
/**
 * Write a description of class NorthWestTerritory here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class NorthWestTerritory extends Territories
{
    /**
     * Act - do whatever the NorthWestTerritory wants to do. This method is called whenever
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("NorthWestTerritoryRed.png");
        else if(currentColor.equals("black"))
            setImage("NorthWestTerritoryBlack.png");
        else if(currentColor.equals("blue"))
            setImage("NorthWestTerritoryBlue.png");
        else if(currentColor.equals("green"))
            setImage("NorthWestTerritoryGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("NorthWestTerritoryLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("NorthWestTerritoryYellow.png");
    }
    public void act() 
    {
        imageSelect();
