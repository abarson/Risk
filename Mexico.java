 ...
 */
public class Mexico extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("MexicoRed.png");
        else if(currentColor.equals("black"))
            setImage("MexicoBlack.png");
        else if(currentColor.equals("blue"))
            setImage("MexicoBlue.png");
        else if(currentColor.equals("green"))
            setImage("MexicoGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("MexicoLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("MexicoYellow.png");
    }
    //-----------------------------------------------------------------------------//
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("WesternUnitedStates"))
            return true;
        else if(tempName.equals("EasternUnitedStates"))
            return true;
        else if(tempName.equals("Venezuela"))
            return true;
        return false;
    }
    public void fortify(){
