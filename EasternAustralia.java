...
/**
 * Write a description of class EasternAustralia here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class EasternAustralia extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("EasternAustraliaRed.png");
        else if(currentColor.equals("black"))
            setImage("EasternAustraliaBlack.png");
        else if(currentColor.equals("blue"))
            setImage("EasternAustraliaBlue.png");
        else if(currentColor.equals("green"))
            setImage("EasternAustraliaGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("EasternAustraliaLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("EasternAustraliaYellow.png");
    }
    //-----------------------------------------------------------------------------//
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("WesternAustralia"))
            return true;
        else if(tempName.equals("NewGuinea"))
            return true;
        return false;
    }
    public void fortify(){
