...
/**
 * Write a description of class Quebec here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Quebec extends Territories
{
    /**
     * Act - do whatever the Quebec wants to do. This method is called whenever
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("QuebecRed.png");
        else if(currentColor.equals("black"))
            setImage("QuebecBlack.png");
        else if(currentColor.equals("blue"))
            setImage("QuebecBlue.png");
        else if(currentColor.equals("green"))
            setImage("QuebecGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("QuebecLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("QuebecYellow.png");
    }
