 ...
 */
public class Indonesia extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("IndonesiaRed.png");
        else if(currentColor.equals("black"))
            setImage("IndonesiaBlack.png");
        else if(currentColor.equals("blue"))
            setImage("IndonesiaBlue.png");
        else if(currentColor.equals("green"))
            setImage("IndonesiaGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("IndonesiaLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("IndonesiaYellow.png");
    }
    //-----------------------------------------------------------------------------//
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("Siam"))
            return true;
        else if(tempName.equals("WesternAustralia"))
            return true;
