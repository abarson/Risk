...
/**
 * Write a description of class SouthAfrica here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class SouthAfrica extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("SouthAfricaRed.png");
        else if(currentColor.equals("black"))
            setImage("SouthAfricaBlack.png");
        else if(currentColor.equals("blue"))
            setImage("SouthAfricaBlue.png");
        else if(currentColor.equals("green"))
            setImage("SouthAfricaGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("SouthAfricaLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("SouthAfricaYellow.png");
    }
    //-----------------------------------------------------------------------------//
