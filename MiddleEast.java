...
/**
 * Write a description of class MiddleEast here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class MiddleEast extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("MiddleEastRed.png");
        else if(currentColor.equals("black"))
            setImage("MiddleEastBlack.png");
        else if(currentColor.equals("blue"))
            setImage("MiddleEastBlue.png");
        else if(currentColor.equals("green"))
            setImage("MiddleEastGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("MiddleEastLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("MiddleEastYellow.png");
    }
    //-----------------------------------------------------------------------------//
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("EastAfrica"))
            ...
            return true;
        else if(tempName.equals("Afghanistan"))
            return true;
