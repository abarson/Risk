...
/**
 * Write a description of class EasternUnitedStates here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class EasternUnitedStates extends Territories
{
    /**
     * Act - do whatever the EasternUnitedStates wants to do. This method is called whenever
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("EasternUnitedStatesRed.png");
        else if(currentColor.equals("black"))
            setImage("EasternUnitedStatesBlack.png");
        else if(currentColor.equals("blue"))
            setImage("EasternUnitedStatesBlue.png");
        else if(currentColor.equals("green"))
            setImage("EasternUnitedStatesGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("EasternUnitedStatesLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("EasternUnitedStatesYellow.png");
    }
    public void act() 
    {
        imageSelect();
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("Quebec"))
            ...
            return true;
        else if(tempName.equals("Mexico"))
            return true;
        return false;
    }
    public void fortify(){
