...
/**
 * Write a description of class Venezuela here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Venezuela extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("VenezuelaRed.png");
        else if(currentColor.equals("black"))
            setImage("VenezuelaBlack.png");
        else if(currentColor.equals("blue"))
            setImage("VenezuelaBlue.png");
        else if(currentColor.equals("green"))
            setImage("VenezuelaGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("VenezuelaLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("VenezuelaYellow.png");
    }
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("Mexico"))
            ...
            return true;
        else if(tempName.equals("Brazil"))
            return true;
        return false;
    }
    //--------------------------------------------------------------------------------//
