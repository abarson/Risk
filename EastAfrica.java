...
/**
 * Write a description of class EastAfrica here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class EastAfrica extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("EastAfricaRed.png");
        else if(currentColor.equals("black"))
            setImage("EastAfricaBlack.png");
        else if(currentColor.equals("blue"))
            setImage("EastAfricaBlue.png");
        else if(currentColor.equals("green"))
            setImage("EastAfricaGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("EastAfricaLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("EastAfricaYellow.png");
    }
    //-----------------------------------------------------------------------------//
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("Egypt"))
            return true;
        else if(tempName.equals("NorthAfrica"))
            return true;
        else if(tempName.equals("Congo"))
            return true;
        else if(tempName.equals("SouthAfrica"))
            return true;
        else if(tempName.equals("Madagascar"))
            return true;
