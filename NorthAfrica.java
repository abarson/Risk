...
/**
 * Write a description of class NorthAfrica here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class NorthAfrica extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("NorthAfricaRed.png");
        else if(currentColor.equals("black"))
            setImage("NorthAfricaBlack.png");
        else if(currentColor.equals("blue"))
            setImage("NorthAfricaBlue.png");
        else if(currentColor.equals("green"))
            setImage("NorthAfricaGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("NorthAfricaLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("NorthAfricaYellow.png");
    }
    //-----------------------------------------------------------------------------//
