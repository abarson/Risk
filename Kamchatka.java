...
/**
 * Write a description of class Kamchatka here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Kamchatka extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("KamchatkaRed.png");
        else if(currentColor.equals("black"))
            setImage("KamchatkaBlack.png");
        else if(currentColor.equals("blue"))
            setImage("KamchatkaBlue.png");
        else if(currentColor.equals("green"))
            setImage("KamchatkaGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("KamchatkaLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("KamchatkaYellow.png");
    }
    //-----------------------------------------------------------------------------//
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("Alaska"))
            return true;
        else if(tempName.equals("Japan"))
            return true;
        else if(tempName.equals("Mongolia"))
            return true;
        else if(tempName.equals("China"))
            return true;
        else if(tempName.equals("Yakutsk"))
            return true;
