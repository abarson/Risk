 ...
 */
public class Madagascar extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("MadagascarRed.png");
        else if(currentColor.equals("black"))
            setImage("MadagascarBlack.png");
        else if(currentColor.equals("blue"))
            setImage("MadagascarBlue.png");
        else if(currentColor.equals("green"))
            setImage("MadagascarGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("MadagascarLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("MadagascarYellow.png");
    }
    //-----------------------------------------------------------------------------//
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("SouthAfrica"))
            return true;
