...
/**
 * Write a description of class GreatBritain here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class GreatBritain extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("GreatBritainRed.png");
        else if(currentColor.equals("black"))
            setImage("GreatBritainBlack.png");
        else if(currentColor.equals("blue"))
            setImage("GreatBritainBlue.png");
        else if(currentColor.equals("green"))
            setImage("GreatBritainGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("GreatBritainLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("GreatBritainYellow.png");
    }
    //-----------------------------------------------------------------------------//
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("Iceland"))
            return true;
        else if(tempName.equals("Scandinavia"))
            return true;
