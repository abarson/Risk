...
/**
 * Write a description of class Irkutsk here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Irkutsk extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("IrkutskRed.png");
        else if(currentColor.equals("black"))
            setImage("IrkutskBlack.png");
        else if(currentColor.equals("blue"))
            setImage("IrkutskBlue.png");
        else if(currentColor.equals("green"))
            setImage("IrkutskGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("IrkutskLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("IrkutskYellow.png");
    }
    //-----------------------------------------------------------------------------//
