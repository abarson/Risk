...
/**
 * Write a description of class WesternEurope here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class WesternEurope extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("WesternEuropeRed.png");
        else if(currentColor.equals("black"))
            setImage("WesternEuropeBlack.png");
        else if(currentColor.equals("blue"))
            setImage("WesternEuropeBlue.png");
        else if(currentColor.equals("green"))
            setImage("WesternEuropeGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("WesternEuropeLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("WesternEuropeYellow.png");
    }
    //-----------------------------------------------------------------------------//
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("GreatBritain"))
            return true;
