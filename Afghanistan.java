...
/**
 * Write a description of class Afghanistan here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Afghanistan extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("AfghanistanRed.png");
        else if(currentColor.equals("black"))
            setImage("AfghanistanBlack.png");
        else if(currentColor.equals("blue"))
            setImage("AfghanistanBlue.png");
        else if(currentColor.equals("green"))
            setImage("AfghanistanGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("AfghanistanLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("AfghanistanYellow.png");
    }
    //-----------------------------------------------------------------------------//
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("Ukraine"))
            return true;
        else if(tempName.equals("MiddleEast"))
            return true;
        else if(tempName.equals("India"))
            return true;
        else if(tempName.equals("China"))
            return true;
        else if(tempName.equals("Ural"))
            return true;
        return false;
    }
    public void fortify(){
