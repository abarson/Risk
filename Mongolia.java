...
/**
 * Write a description of class Mongolia here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Mongolia extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("MongoliaRed.PNG");
        else if(currentColor.equals("black"))
            setImage("MongoliaBlack.PNG");
        else if(currentColor.equals("blue"))
            setImage("MongoliaBlue.PNG");
        else if(currentColor.equals("green"))
            setImage("MongoliaGreen.PNG");
        else if(currentColor.equals("light_blue"))
            setImage("MongoliaLightBlue.PNG");
        else if(currentColor.equals("yellow"))
            setImage("MongoliaYellow.PNG");
    }
    //-----------------------------------------------------------------------------//
