...
/**
 * Write a description of class SouthernEurope here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class SouthernEurope extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("SouthernEuropeRed.png");
        else if(currentColor.equals("black"))
            setImage("SouthernEuropeBlack.png");
        else if(currentColor.equals("blue"))
            setImage("SouthernEuropeBlue.png");
        else if(currentColor.equals("green"))
            setImage("SouthernEuropeGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("SouthernEuropeLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("SouthernEuropeYellow.png");
    }
    //-----------------------------------------------------------------------------//
    ...
    public boolean isAdjacent()
    {
        ...
        if (tempName.equals("WesternEurope"))
            return true;
