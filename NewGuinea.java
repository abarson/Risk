...
/**
 * Write a description of class NewGuinea here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class NewGuinea extends Territories
{
    /**
    ...
    public void imageSelect(){
        if (currentColor.equals("red"))
            setImage("NewGuineaRed.png");
        else if(currentColor.equals("black"))
            setImage("NewGuineaBlack.png");
        else if(currentColor.equals("blue"))
            setImage("NewGuineaBlue.png");
        else if(currentColor.equals("green"))
            setImage("NewGuineaGreen.png");
        else if(currentColor.equals("light_blue"))
            setImage("NewGuineaLightBlue.png");
        else if(currentColor.equals("yellow"))
            setImage("NewGuineaYellow.png");
    }
    //-----------------------------------------------------------------------------//
